...
class DavidModel extends StatelessWidget {
  @override
                  ...
                  children: <Widget>[
                    ...
                    Positioned(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.pushNamed(context, Routes.DavePicsPage);
                        },
                        child: Container(
                          height: 190,
                          width: 190,
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              fit: BoxFit.cover,
                              image: AssetImage('assets/images/dave5.JPG'),
                            ),
                            border: Border.all(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        SizedBox(width: 40),
                        Text(
                          " programming and playing soccer",
                          style: TextStyle(
                            fontSize: 18,
                          ),
                        ),
              ...
              children: <Widget>[
                Row(
                  children: <Widget>[
                    ...
                    Expanded(
                      child: Card(
                        child: Image.asset('assets/images/dave1.JPG'),
                      ),
                    ),
                  ],
                ),
                Row(
                  children: <Widget>[
                    Expanded(
                      child: Card(
                        child: Image.asset('assets/images/dave2.JPG'),
                      ),
                    ),
                    Expanded(
                      child: Card(
                        child: Image.asset('assets/images/dave3.JPG'),
                      ),
                    ),
                    Expanded(
                      child: Card(
                        child: Image.asset('assets/images/classmates.JPG'),
                      ),
                    ),
                  ],
                ),
