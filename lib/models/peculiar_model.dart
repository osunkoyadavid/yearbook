...
class PeculiarModel extends StatelessWidget {
  @override
                  ...
                  children: <Widget>[
                    ...
                    Positioned(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.pushNamed(context, Routes.Peculiar_Pics);
                        },
                        child: Container(
                          height: 190,
                          width: 190,
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              fit: BoxFit.cover,
                              image:
                                  AssetImage('assets/images/display/josh.jpeg'),
                            ),
                            border:
              ...
              children: <Widget>[
                Row(
                  children: <Widget>[
                    Expanded(
                      child: Card(
                        child: Image.asset('assets/images/display/josh.jpeg'),
                      ),
                    ),
                    Expanded(
                      child: Card(
